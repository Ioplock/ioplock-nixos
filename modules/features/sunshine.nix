  ...
  flake.nixosModules.sunshine =
    ...
    in
    {
      services.sunshine = {
        ...
        settings = {
          # Any settings lock out web-UI configuration (declarative mode).
        ...
        # "Low Res Desktop" entry is dropped deliberately: its prep-cmd drives
        # resolution through xrandr, which cannot work under niri/Wayland.
        applications = {
